...
def fetch_ndvi_statistics(corridor_geojson: dict, date_from: str, date_to: str,
    ...
    if response.status_code == 401:
        # Token beklenmedik şekilde geçersiz olmuş olabilir (saat kayması,
        # sunucu tarafı erken invalidation vb.) — bir kez zorla yenileyip
        # tekrar dene. Bu, script'i uzun süre canlı tutan senaryolarda
        # (örn. bir servis içine gömüldüğünde) elle müdahaleyi önler.
